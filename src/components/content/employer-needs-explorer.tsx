...
const needs: EmployerNeed[] = [
  {
    ...
    tags: [
      ...
      { label: "Recruitment Process Outsourcing (RPO)", href: "/services/recruitment-process-outsourcing-rpo/" },
    ],
  },
  {
    title: "Outsource HR",
    ...
    tags: [
      { label: "Retained HR Services", href: "/services/retained-hr-services/" },
      {
        label: "Fractional HR Director / Chief People Officer",
        href: "/services/fractional-hr-director-chief-people-officer/",
      },
      { label: "HR Compliance Audit", href: "/services/hr-compliance-audit/" },
      { label: "Employee Handbooks & HR Policies", href: "/services/employee-handbooks-and-hr-policies/" },
    ],
  },
  {
    ...
    tags: [
      { label: "Workplace Investigations", href: "/services/workplace-investigations/" },
      {
        label: "Workplace Mediation & Conflict Resolution",
        href: "/services/workplace-mediation-and-conflict-resolution/",
      },
      { label: "Redundancy & Restructuring Support", href: "/services/redundancy-and-restructuring-support/" },
      { label: "Employment Tribunal HR Support", href: "/services/employment-tribunal-hr-support/" },
    ],
  },
  {
    ...
    tags: [
      { label: "Organisation Design", href: "/services/organisation-design/" },
      { label: "Leadership & Management Training", href: "/services/leadership-and-management-training/" },
      { label: "Performance Management", href: "/services/performance-management/" },
      { label: "Reward Strategy", href: "/services/reward-strategy/" },
    ],
  },
  {
    title: "Transform HR",
    ...
    tags: [
      { label: "HRIS Implementation", href: "/services/hris-implementation/" },
      { label: "Digital HR Transformation", href: "/services/digital-hr-transformation/" },
      { label: "People Analytics & HR Dashboards", href: "/services/people-analytics-and-hr-dashboards/" },
      { label: "HR Software Selection", href: "/services/hr-software-selection/" },
    ],
  },
];
