    ...
    <Section tone="card">
      <div className="overflow-hidden rounded-md shadow-(--shadow-modal) lg:grid lg:grid-cols-[1fr_0.95fr]">
        <div className="flex flex-col justify-center gap-8 bg-cream p-8 sm:p-10 lg:p-14">
          ...
          <Reveal className="grid gap-6">
            {trust.capabilityStatements.map((item) => {
              ...
              return (
                <div key={item.id} className="grid grid-cols-[auto_1fr] items-start gap-4">
        ...
        <div className="bg-cream p-3 sm:p-4 lg:p-6">
          <Reveal
            delay={0.1}
            className="grid h-full grid-cols-2 gap-px overflow-hidden rounded-md border border-white/15 bg-white/15"
          >
            {featuredStat && (
              <div className="col-span-2 flex flex-col justify-between gap-6 bg-navy p-6 sm:p-8">
            ...
            {otherStats.map((stat) => (
              <div key={stat.id} className="flex flex-col justify-between gap-5 bg-navy p-6 sm:p-8">
                <span className="text-caption font-semibold uppercase tracking-[0.08em] text-white/60">
            ...
            <div className="flex flex-col justify-between gap-5 bg-navy p-6 sm:p-8">
              <span className="text-caption font-semibold uppercase tracking-[0.08em] text-white/60">
