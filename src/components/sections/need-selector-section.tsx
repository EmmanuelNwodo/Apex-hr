 ...
 * video, rather than relying on the video's own brightness. Deliberately
 * not wrapped in scroll-reveal motion and uses plain `Link`s with only CSS
 * hover/focus states (no click-to-select scripting) — every option is
 * reachable and operable by keyboard, and each navigates to a distinct
 * route rather than toggling a shared selection state.
 */
