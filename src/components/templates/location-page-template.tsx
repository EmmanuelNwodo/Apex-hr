...
export function LocationPageTemplate({ title, breadcrumbTrail, location }: LocationPageTemplateProps) {
  ...
  return (
    <div className="bg-surface-page">
      ...
      <section aria-label="Why work with Apex HR here" className="grid grid-cols-1 gap-px overflow-hidden border-b border-border-subtle bg-border-subtle sm:grid-cols-3">
        {trustPointsPrimary.map((point) => (
          <div key={point.title} className="flex items-center gap-4 bg-surface-card p-6">
        ...
        <section id="relevant-services" className="bg-surface-card p-8 sm:p-10 lg:p-14">
          ...
          <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {relatedServices.map((service) => {
              ...
              return (
                <div key={service.slug} className="flex flex-col gap-4 rounded-md border border-border-subtle bg-surface-page p-6">
                  {Icon && (
      ...
      <section aria-label="How we support you here" className="grid grid-cols-1 gap-px overflow-hidden border-b border-border-subtle bg-border-subtle sm:grid-cols-3">
